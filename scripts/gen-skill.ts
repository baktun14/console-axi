/**
 * Generate skills/console-axi/SKILL.md from static, home-view-derived content.
 * The skill teaches an agent how to drive console-axi; it contains no live data.
 */
