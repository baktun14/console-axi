 ...
 * commands that exist in this branch's CLI. NOTE: `main` has no `sdl` command yet;
 * when the SDL feature (sdl templates/init/validate/estimate/screen) merges to
 * main, add a "Building a valid SDL" section here so the skill matches the binary.
 */
